...
?>
<!-- Booking form -->
    <section id="reservation-form" class="parallax-effect mt50 clearfix">
      <div class="col-sm-12 col-md-4">
        <form class="clearfix" role="form" method="post" action="script_reservation.php" name="reservationform" id="reservationform">
